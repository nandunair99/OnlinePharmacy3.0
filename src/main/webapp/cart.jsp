			...
			<div class="container py-5 h-100 cartDiv">
				<div
					...
					<div
						...
						style="border-radius: 15px; border: 5px solid black;">
											...
											<c:forEach var="MedicineBean"
												...
												<div
													...
													<div class="col-md-2 col-lg-2 col-xl-2">
														...
														<input type="text" name="medIdtxt"
															value="${MedicineBean.getMedicineBean().getMedId()}"
															hidden="true"> <img
											...
											<c:forEach var="TestBean"
												...
												<c:if test="${not empty TestBean.getTestBean()}">
													...
													<div
														...
														<div class="col-md-2 col-lg-2 col-xl-2">
															<input type="text" name="cartIdtxt"
																value="${TestBean.getCartId()}" hidden="true"> <input
																type="text" name="testIdtxt"
																value="${TestBean.getTestBean().getTestId()}"
																hidden="true"> <img
																style="height: 100px; width: 100px"
							...
							<div class="col-lg-4 bg-grey">
								<div class="p-5">
									...
									<input type="text" value="${CartWrapper.getTotalAmount()}"
										name="totalAmounttxt" hidden="true">
									<c:if
										test="${empty CartWrapper.getTestBeans() and empty CartWrapper.getMedicineBeans()}">
										<c:set var="btnStatus" value="disabled" scope="page" />
									</c:if>
									<input type="submit" class="btn btn-dark btn-block btn-lg"
										value="Checkout" <c:out value='${btnStatus}'/>
