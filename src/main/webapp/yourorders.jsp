            ...
            <div class="card-header bg-white">
                <div
                    ...
                    <a href="${referrer}">
                        ...
                        <button
                                style="float: right; background-color: red; color: black; height: 20px; width: 20px">
                            &times;
                        </button>
                    </a>
                </div>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body my-auto text-right">
                                                    <div class="row my-auto flex-column flex-md-row">
                                                        ...
                                                        <div class="col my-auto">
                                                            <h6 class="mb-0">
                                                                &#8377;${MedicineBean.getMedicineBean().getMedPrice()}</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body my-auto text-right">
                                                            <div class="row my-auto flex-column flex-md-row">
                                                                ...
                                                                <div class="col my-auto">
                                                                    <h6 class="mb-0">
                                                                        &#8377;${TestBean.getTestBean().getTestPrice()}</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="col">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="flex-sm-col col-auto">
                                        <p class="mb-1">
                                            &#8377;${PastOrder.getCartWrapper().getTotalAmountWithoutDiscount()}</p>
                                    </div>
                                </div>
                                <div class="row justify-content-between">
                                    <div class="flex-sm-col text-right col">
                                    ...
                                    <div class="flex-sm-col col-auto">
                                        <p class="mb-1">
                                            &#8377;${PastOrder.getCartWrapper().getTotalAmountWithoutDiscount()-PastOrder.getCartWrapper().getTotalAmount()}</p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col mt-auto">
                                ...
                                <div class="media row justify-content-between ">
                                    ...
                                    <div class="flex-col">
                                        <span> <small class="text-right mr-sm-2">Dispatched</small><i
