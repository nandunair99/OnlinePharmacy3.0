...
<div class="mainArea">
    ...
    <div>
        <form method="post"
              action="${pageContext.request.contextPath}/medicine${Constant.URL_MEDICINE_UPDATE_ACTION}?medId=${mbean.getMedId()}"
            ...
            <table>
                    ...
                    <td>
                        <div class="form-group">
                            <label for="medIdtxt">Medicine Id:</label> <input
                                class="form-group" type="text" name="medId" id="medIdtxt"
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <textarea name="medDescription"
                                      id="medDescriptiontxt">${mbean.getMedDescription()}</textarea>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <label for="medExpDatetxt">Exp date:</label> <input type="date"
                                                                                name="medExpDate" id="medExpDatetxt"
                                                                                value="${exp}">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <input type="text" value="${mbean.getMedId()}" name="oldPictxt"
                               hidden="true">
                    </td>
                </tr>
                <tr>
