    ...
    <table class="table table-borderless">
        ...
        <c:forEach var="mbean" items="${MedicineList}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/medicine${Constant.URL_MEDICINE_UPDATE_FORM}?medId=${mbean.getMedId()}"><span
                            class="glyphicon glyphicon-pencil"></span></a></td>
                <td>
                    <a href="${pageContext.request.contextPath}/medicine${Constant.URL_MEDICINE_DELETE_ACTION}?medId=${mbean.getMedId()}"><span
                            class="glyphicon glyphicon-trash Delete"></span></a></td>
                <td>
                    <a href="${pageContext.request.contextPath}/medicine/${Constant.URL_MEDICINE_SINGLE_VIEW}?medId=${mbean.getMedId()}"><span
