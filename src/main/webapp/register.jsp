									...
									<div class="row">
										<div class="col-md-3">
											<div class="form-outline">
												...
												<input type="text" id="fnametxt" name="fnametxt" value="${CustomerBean.getFirstName()}"
										...
										<div class="col-md-3 mb-4">
											<div class="form-outline">
												<label class="form-label" for="lnametxt">Last name</label> <input
													type="text" id="lnametxt" name="lnametxt"  value="${CustomerBean.getLastName()}"
										...
										<div class="col-md-3 mb-4">
											<div class="form-outline">
												<label class="form-label" for="contactNotxt">Contact
													no.</label> <input type="text" id="contactNotxt"  value="${CustomerBean.getContactNo()}"
													name="contactNotxt" class="form-control form-control-lg" />
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												...
												<textarea class="form-control form-control-lg"
													id="addresstxt" name="addresstxt">${CustomerBean.getAddress()} </textarea>
											</div>
										</div>
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												<label class="form-label" for="mailtxt">Email ID</label> <input
													...
													class="form-control form-control-lg"  value="${CustomerBean.getEmailId()}"/>
											</div>
										</div>
										<div class="col-md-6 mb-4">
											<div class="form-outline">
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												<label class="form-label" for="cpasswordtxt">Confirm
													...
													name="cpasswordtxt" class="form-control form-control-lg" />
											</div>
										</div>
										&nbsp;
										...
										<div class="col-md-6 mb-4">
											<div class="d-flex justify-content-end pt-3">
												...
												<input type="submit" class="btn btn-lg ms-2" style="background-color:#F39C12"
													value="Submit
												form">
											</div>
											<h4 style="color: red">
